...
public class HMSClient extends Application {
  ...
  //  static File file= new File("src/Music/noti.mp3");
    //static File file = new File(HMSClient.class.getResource("noti.mp3").toExternalForm());
   // static Media notiMusic = new Media(file.toURI().toString());
